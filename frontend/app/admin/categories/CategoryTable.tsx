...
export default function CategoryTable({ categories, isLoading }: Props) {
    return (
        <div>
                        ...
                        <div key={cat.id}
                            ...
                            <div className="flex items-center justify-between pt-4 border-t border-gray-700/50">
                                <div className="flex gap-2">
                                    <Button className="p-2 bg-blue-600/10 hover:bg-blue-600 text-blue-500 hover:text-white rounded-lg transition-colors border border-blue-600/20">
